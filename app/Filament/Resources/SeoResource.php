...
class SeoResource extends Resource
{
    ...
    protected static ?string $slug = 'seos';
        ...
        return $form
            ->schema([
                Placeholder::make('created_at')
                    ->label('Created Date')
                    ->content(fn (?Seo $record): string => $record?->created_at?->diffForHumans() ?? '-'),

                Placeholder::make('updated_at')
                    ->label('Last Modified Date')
                    ->content(fn (?Seo $record): string => $record?->updated_at?->diffForHumans() ?? '-'),
