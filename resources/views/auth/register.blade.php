...
@section('content')
    ...
    <x-forms.auth-form title="Регистрация">
        ...
        <ul class="space-y-3">
            <li>
                <a href="{{ route('register.mail.show') }}"
        ...
        <x-slot:links>
            <div class="space-y-3 mt-5">
                <div class="text-xxs md:text-xs">Есть аккаунт? <a href="{{route('login.show')}}" class="text-white hover:text-white/70 font-bold underline underline-offset-4">Войти</a></div>
            </div>
        </x-slot:links>
