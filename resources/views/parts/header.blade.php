    ...
    <div class="container">
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                <form class="hidden lg:flex gap-3" action="{{route('catalog.index')}}">
                    <input type="search"
                           name="filters[search]"
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                @auth()
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        ...
                        >
                            ...
                            <div class="mt-4">
                                <ul class="space-y-2">
                                    <li><a href="{{ route('profile.orders') }}" class="text-body hover:text-white text-xs font-medium">Мои
                                            заказы</a></li>
                ...
                @else
                    <a href="{{route('login.show')}}" class="profile hidden xs:flex items-center">
                ...
                <a href="{{ route('cart.index') }}" class="flex items-center gap-3 text-pink hover:text-white">
                    ...
                    <div class="hidden sm:flex flex-col gap-2">
                        ...
                        <span
                            class="text-white text-xxs 2xl:text-xs font-bold !leading-none">{{ cart()->getTotalPrice()}}</span>
                    </div>
                </a>
