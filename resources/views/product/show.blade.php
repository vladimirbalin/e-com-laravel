        ...
        <div class="container">
                ...
                <div class="basis-full lg:basis-3/5 xl:basis-2/4">
                    <div class="grow flex flex-col lg:py-8">
                        ...
                        <div class="flex items-baseline gap-4 mt-4">
                            <div
                                class="text-pink text-lg md:text-xl font-black">{{ $product->price->getFormattedValueWithSymbol() }}</div>
            ...
            <section class="mt-12 xl:mt-16 pt-8 lg:pt-12 border-t border-white/10">
                ...
                <article class="text-xs md:text-sm">
                    ...
                    <p class="mb-12">Aerox 3 оптимизирована для получения самых быстрых движений в играх, поэтому вы
                        всегда на шаг впереди конкурентов. Когда на счету миллисекунды, скорость имеет значение.</p>
